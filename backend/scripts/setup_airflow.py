...
[database]
sql_alchemy_conn = postgresql://${username}:${password}@${your-rds-endpoint}:5432/airflow
""")
    
    # Create symbolic link to DAG file
    dag_source = os.path.join(project_root, 'backend/data_pipeline/dags/patient_insight_dag.py')
